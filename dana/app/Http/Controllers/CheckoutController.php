...

    {
        ...
        if ($carts && count($carts) > 0) {
            ...
            foreach ($carts as $key => $cartItem) {
                ...
                $calculateweight = ($product->lenght*$product->width*$product->height)/6000;
                $calculateweightlbs = $calculateweight*2.20462;
               ...
               if($shipping_info->country_id == '231'){
                          $shipping = '0';
                 }
                         elseif($weightlbs > $calculateweightlbs){
            
                        $cartItem['shipping_cost'] = $weightlbs*  $cartItem['quantity'] * 8;
                              }
                            
                        else{
                        $cartItem['shipping_cost'] = $calculateweightlbs *  $cartItem['quantity'] * 8;
