                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Lenght')}} <small>({{ translate('In cm') }})</small></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="lenght" value="{{ $product->lenght }}" step="0.01" placeholder="0.00">
                            </div>
                        </div>
                         <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Width')}} <small>({{ translate('In cm') }})</small></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="width" value="{{ $product->width }}" step="0.01" placeholder="0.00">
                            </div>
                        </div>
                         <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Height')}} <small>({{ translate('In cm') }})</small></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="height" value="{{ $product->height }}" step="0.01" placeholder="0.00">
                            </div>
                        </div>
                        <div class="form-group row">
