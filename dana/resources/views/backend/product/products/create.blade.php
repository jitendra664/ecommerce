                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="number" class="form-control" name="lenght" step="0.01" value="0.00" placeholder="0.00">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="number" class="form-control" name="width" step="0.01" value="0.00" placeholder="0.00">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="number" class="form-control" name="height" step="0.01" value="0.00" placeholder="0.00">
