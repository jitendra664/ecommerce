    					...
    					<div class="card-body">
                            ...
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
    								...
    								<label>{{ translate('Contact address 2') }} ({{ translate('Translatable') }})</label>

    								<input type="hidden" name="types[][{{ $lang }}]" value="contact_address_2">

    								<input type="text" class="form-control" placeholder="{{ translate('Address 2') }}" name="contact_address_2" value="{{ get_setting('contact_address_2',null,$lang) }}">
                                ...
                                <div class="form-group">
    								...
    								<label>{{ translate('Contact phone (optional)') }}</label>

    								<input type="hidden" name="types[]" value="contact_phone_optional">

    								<input type="text" class="form-control" placeholder="{{ translate('Phone 2') }}" name="contact_phone_optional" value="{{ get_setting('contact_phone_optional') }}">
