                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        ...
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            ...
                            <a href="{{ route('shops.create') }}" class="text-secondary fs-12 pr-3 d-inline-block border-width-2 border-right">{{ get_setting('contact_email')  }}</a>
                        ...
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            ...
                            <a href="{{ route('seller.login') }}" class="text-secondary fs-12 pl-3 d-inline-block">{{ get_setting('contact_phone') }}</a>
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white">
                ...
                <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                    ...
                    <a class="d-block py-2 mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @if($header_logo != null)
                            ...
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-95px h-md-95px" height="95">

                        @else

                            <img src="{{ static_asset('assets/img/Shop&ShipLogo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-50px h-md-100px" height="40">
    ...
    <div class="d-none d-lg-block position-relative bg-primary h-50px" style="background-color: #ef7b8e !important;">
