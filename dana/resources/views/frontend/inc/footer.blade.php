...
<section class="py-4 text-light footer-widget border-bottom" style="border-color: #3d3d46 !important; background-color: #212129 !important;">
        ...
        <!-- <div class="mt-3 mb-4">
            ...
            <a href="{{ route('home') }}" class="d-block">
                ...
                @else
                    ...
                    <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/Shop&ShipT.png') }}" alt="{{ env('APP_NAME') }}" height="44" style="height: 100px;">
                    ...
                    <form method="POST" action="{{ route('subscribers.store') }}">
                        ...
                        <div class="row gutters-10">
                            ...
                            <div class="col-4" >
                                ...
                                <button type="submit" class="btn btn-primary rounded-0 w-100" style="background-color: #ef7b8e; border-color: #ef7b8e;">{{ translate('Subscribe') }}</button>
...
<section class="py-lg-3 text-light footer-widget" style="background-color: #212129 !important;">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <p  class="fs-13 text-secondary mb-1"></p>

                            <p  class="fs-13 text-soft-light">{{ get_setting('contact_address_2',null,App::getLocale()) }}</p>
                        ...
                        <li class="mb-2">
                            ...
                            <p  class="fs-13 text-soft-light">{{ get_setting('contact_phone_optional') }}</p>
            ...
            <div class="mt-3 mb-4">
                ...
                <a href="{{ route('home') }}" class="d-block">
                    ...
                    @else
                        ...
                        <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/Shop&ShipT.png') }}" alt="{{ env('APP_NAME') }}" height="44" style="height: 200px;">
 ...
 -->
    ...
    <div id="gb-widget-7011" style="bottom: 14px; right: 16px; opacity: 1; transition: opacity 0.5s ease 0s; box-sizing: border-box; direction: ltr; text-align: right; position: fixed !important; z-index: 16000160 !important;width: 60px;">
    <div class="q8c6tt-2 eiGYSu">
        <span id="close-icon" style="position: absolute; top: -19px; right: 3px; cursor: pointer; font-size: 28px; color: black; z-index: 2000; padding: 5px; border-radius: 50%;">&times;</span>
        <a size="50" href="https://wa.me/+12027630627" target="_blank" color="#4dc247" id="" class="q8c6tt-0 jWcIXO" style="flex-shrink: 0;width: 50px;height: 50px;order: 2;padding: 5px;box-sizing: border-box;border-radius: 50%;cursor: pointer;overflow: hidden;box-shadow: rgb(0 0 0 / 40%) 2px 2px 6px;transition: all 0.5s ease 0s;position: relative;z-index: 1000;display: block;border: 0px;background-color: rgb(77, 194, 71) !important;">
